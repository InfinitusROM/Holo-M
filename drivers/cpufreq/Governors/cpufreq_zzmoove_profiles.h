 ...
 * ------------------------------------------------------------------------------------------------------------------------------------------
 * ------------------------------------------------------------------------------------------------------------------------------------------
 * - (12)'lwk'-> Lwk Special       		  -> NEW! Exclusively for Light Wieght Kernel (S4 i9500 exynos )                   -
 * ------------------------------------------------------------------------------------------------------------------------------------------
 *
...
#define PROFILE_MAX_FREQ (2333000)	// ZZ: max possible freq in system table for freq adaption (possible OC frequencies inclusive)
